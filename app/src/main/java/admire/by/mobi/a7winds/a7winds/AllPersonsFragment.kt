...
class AllPersonsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_persons, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val layout = view.findViewById<LinearLayout>(R.id.all_persons_layout)
        ...
        for(i in 0 until persons.length()) {
            if(persons.getJSONObject(i).getInt("status") == 1) {
                ...
                view.findViewById<View>(R.id.all_persons_empty).visibility = View.GONE
                count++
            }
        }
    }
